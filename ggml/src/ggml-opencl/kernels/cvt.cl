...
//------------------------------------------------------------------------------
// block_q2_0 (g128 ternary: 2-bit codes, one FP16 scale per 128 weights)
//------------------------------------------------------------------------------
typedef struct {
    half d;             // delta
    uchar qs[QK2_0/4];  // 2-bit codes (32 bytes)
} block_q2_0;
...
//------------------------------------------------------------------------------
// kernel_convert_block_q2_0
// Convert block_q2_0 (AOS) to 2 separate arrays (SOA): quant bytes + scales.
// q2_0 codes are stored in natural order (2-bit field j of byte i -> weight 4*i + j)
//------------------------------------------------------------------------------
